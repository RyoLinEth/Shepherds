  ...
  const items = [
    {
      ...
      title: "0 Buy Tax",
      description: "With 0 tax of buying, more people would buy our token since there's no tax."
    },
    {
      svgPath: (
        <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      ...
      title: "Low Sell Tax",
      description: "To maintain our goal, promoting the dinosaur to the world. We need a little sell tax."
    },
    {
      svgPath: (
        <svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
              {
                items.map((item, index) => {
                  return (
                    <div
                      key={item.title}
                      className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                      {item.svgPath}
